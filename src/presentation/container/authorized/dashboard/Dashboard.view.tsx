...
const LEGENDS = ['New', 'Active', 'Lend', 'Problem', 'Disable'];
...
export const Dashboard: React.FC<DashboardProps> = (props) => {
  ...
  const data = [20, 30, 20, 10, 20];
  const colors = [accent, ocean, red, orange, gray];
  const pieData = data
    ...
    <>
      ...
      <View style={[styles.container]}>
        <View style={styles.chartContainer}>
          <TextView
            text="Biểu đồ thống kê hoạt động hàng tháng"
            style={{
              fontSize: 24,
              fontWeight: 'bold',
              marginBottom: 8,

      ...
      <View style={styles.container}>
        <View style={styles.form}>
          <TextField
            ...
            prefix={<Icon color={Colors.gray} type="ionicon" name="warning" />}
            inputProps={{
          ...
          <TextField
            containerStyle={styles.input}
            prefix={<Icon color={Colors.gray} type="ionicon" name="location" />}
            inputProps={{
              placeholder: 'Vị trí',
            }}
          />
          ...
          <TextField
            containerStyle={styles.input}
            prefix={<Icon color={Colors.gray} type="ionicon" name="calendar" />}
            inputProps={{
          ...
          <Pressable style={styles.imageUpload}>
            <IconLabel
              prefix={<Icon color="white" type="ionicon" name="cloud-upload" />}
              color="white"
              text="Upload image"
            />
          </Pressable>
